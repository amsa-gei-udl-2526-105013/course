---
title: "Laboratori: AWS Lambda, CloudWatch i Arquitectures Serverless d’Events"
subtitle: "Administració de Sistemes i Aplicacions"
...
:::{.callout-warning title="Problemes de codificació?"}
...
És el temps addicional necessari perquè AWS inicialitzi un nou entorn d’execució per a Lambda.
Aquest temps només apareix quan:
...
- Podeu utiltizar les imatges reals: 
  - [Cèl·lules 1](./src/cells/IMG00197.JPG)
  - [Cèl·lules 2](./src/cells/IMG00207.JPG)
  - [Cèl·lules 3](./src/cells/IMG00226.JPG)
  - [Cèl·lules 4](./src/cells/IMG00230.JPG)
  - [Cèl·lules 5](./src/cells/IMG00232.JPG)
  - [Cèl·lules 6](./src/cells/IMG00250.JPG)

## Presentació del laboratori

Documenta els passos seguits, els reptes trobats i les solucions implementades. Inclou captures de pantalla dels buckets S3 amb les imatges processades i els resultats obtinguts. Cal entregar un informe escrit en format PDF amb la resolució de les 3 tasques proposades.
